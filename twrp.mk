...
TARGET_RECOVERY_DEVICE_MODULES += libicuuc libxml2 libion libhardware_legacy android.system.suspend@1.0 libandroidicu libicui18n libashmemd_client ashmemd_aidl_interface-cpp vendor.display.config@1.0 device_manifest.xml system_manifest.xml
...
PRODUCT_COPY_FILES += \
    $(OUT_DIR)/target/product/wayne/system/lib64/android.system.suspend@1.0.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/android.system.suspend@1.0.so \
    $(OUT_DIR)/target/product/wayne/system/lib64/ashmemd_aidl_interface-cpp.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/ashmemd_aidl_interface-cpp.so \
    $(OUT_DIR)/target/product/wayne/obj/SHARED_LIBRARIES/libandroidicu_intermediates/libandroidicu.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libandroidicu.so \
    $(OUT_DIR)/target/product/wayne/system/lib64/libhardware_legacy.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libhardware_legacy.so \
    $(OUT_DIR)/target/product/wayne/system/lib64/libion.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libion.so \
    $(OUT_DIR)/target/product/wayne/system/lib64/libashmemd_client.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libashmemd_client.so \
    $(OUT_DIR)/target/product/wayne/system/lib64/libicui18n.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libicui18n.so \
    $(OUT_DIR)/target/product/wayne/system/etc/vintf/manifest.xml:$(TARGET_COPY_OUT_RECOVERY)/root/system/etc/vintf/manifest.xml \
    $(OUT_DIR)/target/product/wayne/system/lib64/libxml2.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libxml2.so \
    $(OUT_DIR)/target/product/wayne/vendor/lib64/libicuuc.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libicuuc.so \
    $(OUT_DIR)/target/product/wayne/vendor/lib64/vendor.display.config@1.0.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/vendor.display.config@1.0.so \
    $(OUT_DIR)/target/product/wayne/vendor/etc/vintf/manifest.xml:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/etc/vintf/manifest.xml \
